  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <main className="pt-20">
        ...
        {/* Footer */}
        <footer className="border-t border-cosmic-purple/20 bg-cosmic-purple/5 backdrop-blur">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
              <div>
                <div className="flex items-center gap-2 mb-4">
                  <Sparkles className="w-5 h-5 text-cosmic-purple" />
                  <span className="font-bold text-cosmic-purple">Cosmic Hub</span>
                </div>
                <p className="text-gray-400 text-sm">
              ...
              <div>
                <h4 className="text-cosmic-purple font-semibold mb-4">Explore</h4>
                <ul className="space-y-2 text-sm text-gray-400">
                  <li>
                    <a href="#podcast" className="hover:text-cosmic-purple transition">
                      Podcast
                    </a>
                  </li>
                  <li>
                    <a href="#music" className="hover:text-cosmic-purple transition">
                      Music
                    </a>
                  </li>
                  <li>
                    <a href="#experience" className="hover:text-cosmic-purple transition">
                      Experience
                    </a>
                  </li>
                </ul>
              ...
              <div>
                <h4 className="text-cosmic-purple font-semibold mb-4">Collections</h4>
                <ul className="space-y-2 text-sm text-gray-400">
                  <li>
                    <a href="#nft" className="hover:text-cosmic-purple transition">
                      NFT Collections
                    </a>
                  </li>
                  <li>
              ...
              <div>
                <h4 className="text-cosmic-purple font-semibold mb-4">Connect</h4>
                <ul className="space-y-2 text-sm text-gray-400">
                  <li>
                    <a href="#" className="hover:text-cosmic-purple transition">
                      Twitter
                    </a>
                  </li>
                  <li>
            ...
            <div className="border-t border-cosmic-purple/20 pt-8 text-center text-gray-500 text-sm">
              <p>
