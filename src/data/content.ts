export const siteContent = {
  ...
  nftCollections: {
    ...
    description:
      "Discover my portfolio of high-fidelity digital art where AI and human imagination converge. Showcasing diverse styles and aesthetics, open for potential commissions.",
    enabled: true,
    collections: [
      // Add collections: { url: "link", name: "Name", image: "optional" }
    ],
  },
