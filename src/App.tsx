...
<section className="relative flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden py-12 sm:py-20">
  ...
  <div className="relative w-full max-w-7xl h-[400px] sm:h-[500px] flex items-center justify-center">
   ...
   {/* 1. КАРУСЕЛЬ (z-10) */}
{/* Убрали pointer-events-none отсюда */}
<div className="cosmic-perspective absolute inset-0 flex items-center justify-center z-10">
  {/* Добавили pointer-events-none только для спиннера, если нужно, 
      но лучше управлять кликами на уровне карточек */}
  <div className="cosmic-spinner">
    {artworks.map((art, index) => {
      ...
      return (
        ...
        >
          {/* Ссылка должна иметь pointer-events-auto, чтобы принимать клики */}
          <a 
            href={art.link} 
            target="_blank" 
            rel="noopener noreferrer"
            className="pointer-events-auto block rounded-2xl overflow-hidden border border-cosmic-purple/30 bg-black/40 backdrop-blur-md shadow-2xl hover:scale-105 transition-transform duration-300"
          >
    ...
    <div className="relative z-20 text-center max-w-4xl mx-auto pointer-events-none">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pointer-events-auto mt-10">
        ...
        <a
          href="https://youtu.be/Xy5Q4dwcjxw"
          target="_blank"
          rel="noopener noreferrer"
