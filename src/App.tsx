...
<iframe width="100%" height="100%" src={winnerShowcase.video} frameBorder="0" allowFullScreen />
</div>
...
<div key={idx} className="rounded-xl overflow-hidden border border-white/5 bg-white/5">
